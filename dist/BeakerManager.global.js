// Built at: 2026-04-04T11:05:47Z sha:4c80f57d9a5c14a1cda6e9611ca4c43110b5705f
"use strict";
var AtomEngine = (() => {
  ...
  var BeakerManager_exports = {};
  __export(BeakerManager_exports, {
  ...
  // src/atoms/ChoiceAtom.ts
  var ChoiceAtom = class {
    constructor(context, element, config) {
      this.capability = "choice";
      this.container = null;
      this.context = context;
      this.id = config.id;
      this.config = config;
        ...
        try {
          switch (atomConfig.capability) {
            ...
            case "flex":
              ...
              break;
            case "choice":
              this.contentAtoms.push(new ChoiceAtom(context, this.element, {
                id: atomConfig.id,
                placeholder: atomConfig.placeholder,
  ...
  return __toCommonJS(BeakerManager_exports);
})();
